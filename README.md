...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-ggresidpanel-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-ggresidpanel-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-ggresidpanel
# for installing globally
pixi global install r-ggresidpanel
```
...
It is possible to list all of the versions of `r-ggresidpanel` available on your platform:
...
```
pixi search r-ggresidpanel --channel conda-forge
```
